...
ALTER TABLE MOVIE_CATEGORY ADD CONSTRAINT FK_Movie FOREIGN KEY (movieID) REFERENCES MOVIE(movieID);
ALTER TABLE MOVIE_CATEGORY ADD CONSTRAINT FK_Category FOREIGN KEY (categoryID) REFERENCES CATEGORY(categoryID);
...
ALTER TABLE SEAT ADD CONSTRAINT FK_SeatType FOREIGN KEY (seatType) REFERENCES SEAT_TYPE(seatType);
...
ALTER TABLE SHOWTIME_PRICE ADD CONSTRAINT FK_ShowtimeSeat FOREIGN KEY (seatType) REFERENCES SEAT_TYPE(seatType);
...
ALTER TABLE SEAT_SHOWTIME ADD CONSTRAINT FK_SEAT_SHOWTIME_USER FOREIGN KEY (userID) REFERENCES USER(userID);
ALTER TABLE SEAT_SHOWTIME ADD CONSTRAINT FK_SEAT_SHOWTIME_BOOKING FOREIGN KEY (bookingID) REFERENCES BOOKING(bookingID);
ALTER TABLE SEAT_SHOWTIME ADD CONSTRAINT FK_SEAT_SHOWTIME_SHOW FOREIGN KEY (showID) REFERENCES SHOWTIME(showID);
ALTER TABLE SEAT_SHOWTIME ADD CONSTRAINT FK_SEAT_SHOWTIME_SEAT FOREIGN KEY (seatID) REFERENCES SEAT(seatID);
